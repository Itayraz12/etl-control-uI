  ...
  return (
    <>
      <Card style={{ marginBottom: 0 }}>
        ...
        <div data-testid="team-management-message-slot" style={MESSAGE_SLOT_STYLE}>
          {notice && (
            <div data-testid="team-management-notice" style={NOTICE_BANNER_STYLE}>
              {notice}
            </div>
          )}

          {screenError && (
            <div data-testid="team-management-error" style={ERROR_BANNER_STYLE}>
              {screenError}
            </div>
          )}

          {formError && editingKey && (
            <div data-testid="team-management-form-error" style={FORM_ERROR_BANNER_STYLE}>
              {formError}
            </div>
          )}
        </div>
